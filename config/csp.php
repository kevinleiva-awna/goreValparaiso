...
return [
     ...
     */
    'policy' => App\Support\Csp\GoreCspPolicy::class,
     ...
     *
     * GORE: deshabilitado porque los componentes Blade existentes usan style="..."
     * inline y agregar nonce a cada uno requiere refactor mayor. La policy
     * compensa con 'unsafe-inline' SOLO en style-src; script-src se mantiene
